      ...
      <main className="w-full max-w-5xl space-y-16">
        <section className="space-y-6 text-center">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-zinc-950 sm:text-5xl dark:text-zinc-50">
            Share smarter, shorter links.
          </h1>
          <p className="mx-auto max-w-2xl text-base leading-7 text-zinc-600 sm:text-lg dark:text-zinc-400">
            Create short links and manage them from a clean dashboard designed
            for fast teams.
          </p>
        </section>
        ...
        <section className="grid gap-4 sm:grid-cols-3">
          <article className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              Create branded, memorable links your audience trusts and
              remembers.
            </p>
          </article>
          ...
          <article className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              Route protection and secure authentication keep your workspace
              private.
            </p>
          </article>
          ...
          <article className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              A lightweight interface helps you launch and manage links in
              seconds.
            </p>
          </article>
        </section>
        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-8 text-center dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-zinc-600 dark:text-zinc-400">
            Join LinkLite to create and manage short links from a clean, fast
            dashboard.
          </p>
          <div className="mt-6">
